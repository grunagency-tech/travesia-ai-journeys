...
serve(async (req) => {
  ...
  try {
    ...
    if (userLocation?.city || userLocation?.country) {
      ...
      locationContext = `\n\nContext: The user's current location appears to be: ${parts.join(", ")}. You may suggest it as origin if the user doesn't specify one. REMEMBER: respond in the user's language, NOT necessarily English.`;
    }
